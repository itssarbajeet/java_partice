...
class A51_ChocolateDistributionProblem {
    ...
    public static void main(String args[]) {
        ...
        int m = 3;
        A51_ChocolateDistributionProblem problem = new A51_ChocolateDistributionProblem();
        long minDiff = problem.findMinDiff(a, a.size(), m);
